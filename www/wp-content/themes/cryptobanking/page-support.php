  ...
  <main class="main">
    ...
    <div class="support">
      ...
      <p class="support__text">
          ...
          ?>
        Если у Вас возникли какие-то вопросы по нашему сервису вы можете задать их по этому адресу <a class="support__mail-link" href="mailto:<?= $mail?>"><?= $mail?></a>
        ...
        <form action="<?= get_template_directory_uri()?>/send_question.php" method="POST" class="form support__form" role="form" id="js-supForm" novalidate>
          ...
          <button class="form__submit" type="submit">Отправить сообщение</button>
        </form>
    </div>
  </main>
